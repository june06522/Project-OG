...
public class BatFSMController : FSM_Controller<EBatState>
{
    ...
    protected override void Awake()
    {
        ...
        var idleToChase = new TransitionGoIdleOrChase(this, EBatState.Chase);

        idleState
            .AddTransition<EBatState>(idleToChase);

        var chaseState = new BatChaseState(this);
        var chaseToIdle = new TransitionGoIdleOrChase(this, EBatState.Idle);
